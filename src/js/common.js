...
$.validator.addMethod("nameonly", function(value, element) {
	return this.optional(element) || /^[A-Za-zА-ЯҐЄІЇа-яґєії][A-Za-zА-ЯҐЄІЇа-яґєії\'\’\-]+([ A-Za-zА-ЯҐЄІЇа-яґєії][A-Za-zА-ЯҐЄІЇа-яґєії\'\’\-]|\s+)*$/i.test(value);
}, "Letters only please");

$.validator.addMethod("phonenum", function(value, element) {
	var onlynumber = value.replace(/[^0-9]/g, "");
	return this.optional(element) || onlynumber.length == 12 && onlynumber.match(/^[0-9]{12}$/);
